...
const Login = () => {
  ...
  return (
    <>
      ...
      <div  className="howToLogin d-flex flex-column justify-content-center align-items-start  mt-3">
      ...
      <hr className='horizontal-line'/>
       ...
       <div className='dontHaveAccount d-flex align-items-center rounded-4'>
